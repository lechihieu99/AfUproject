        ...
        <>
            <div className="w-full h-full flex justify-center items-center">
                <div className="loader">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" height="30" width="30" className="inline-block">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" style={{ rotationDuration: '0ms', rotationDirection: 'normal' }} viewBox="0 0 64 64" height="30" width="30" className="inline-block">
