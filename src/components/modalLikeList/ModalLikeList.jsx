...
import { userLikeList } from "../../redux/slice/Status.slice";

const ModalLikeList = ({ show, setShow }) => {
    ...
    return (
        <Modal show={show} onClose={() => setShow(false)} className="modalEdit">
            <Modal.Header>
                <div className="text-gray-200">Đã thích</div>
            </Modal.Header>
            <Modal.Body>
                            ...
                            <div className="w-full flex">
                                <div className="w-[15%] flex flex-col items-start justify-start gap-4 p-4" >
                                    <div className="w-full flex gap-2 items-center">
                                        <ThumbsUp size={20} weight="fill" className={`text-pink-velvet cursor-pointer`} />
                                    ...
                                    <div className="w-full flex gap-2 items-center">
                                        <Star size={20} weight="fill" className={`text-green-400 cursor-pointer`} />
