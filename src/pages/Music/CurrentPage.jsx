...
import { getCurrentList, getInfoSong, getLyricsSong, getPlaylist, getTop100 } from "../../redux/slice/Music.slice";
import PlaylistSong from "./PlaylistSong";



const CurrentPage = ({ isPlaying, setIsPlaying, playingList, setPlayingList, selectedId, setSelectedId }) => {
                ...
                <div className="w-full sm:w-[70%] h-full bg-black-200 pt-4 px-6 rounded-sm overflow-y-auto">
                    ...
                    <div className="w-full text-3xl text-white flex justify-start items-center pb-2 gap-4" style={{ height: 'calc(100% - 50px)' }}>
                        ...
                        <div className="w-full sm:w-2/3 h-full pt-2">
                            ...
                            <PlaylistSong playlist={currentList?.data} isPlaying={isPlaying} playingList={playingList} setPlayingList={setPlayingList} setIsPlaying={setIsPlaying}
